...
<div class="task-modal-overlay" id="taskEditModalOverlay">
  <div class="task-modal">
    <div class="task-modal-head">
      ...
      <button class="task-modal-close" id="taskModalCloseBtn"><i data-lucide="x" style="width:18px;height:18px;"></i></button>
    </div>
    ...
    <div class="task-modal-foot">
      <button class="task-modal-btn task-modal-btn-secondary" id="taskModalNudgeBtn" style="display:none"><i data-lucide="mail" style="width:14px;height:14px;"></i> Send Nudge</button>
