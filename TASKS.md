...
- [ ] **[Hi]** Schedule call with Bob - offer talk to Brim or Glen (Travelers Insurance) — assigned:Oscar
...
- [ ] **[Med]** Schedule in person visit (Texas Permanent School Fund) — assigned:Tony Avila
...
- [ ] **[Hi]** Create agenda + presentation for meeting Mar 17 — strategy-focused (Future Fund) — assigned:Oscar
- [x] **[Hi]** [STATUS:complete] Talk to Tim Avila about RXR — assigned:Oscar
- [ ] **[Med]** Send message to Marianne Barrotti in Spanish (World Bank) — assigned:Oscar
- [ ] **[Hi]** Connect with CHERN Family Office via Canarelli — assigned:Tony
- [ ] **[Hi]** Call Chuck from Berkshire Hathaway (Berkshire Hathaway) — assigned:Tony
...
- [ ] **[Med]** Schedule call with Michael Wigrizer to strategize on Ira referrals — assigned:Oscar
...
- [ ] **[Med]** Review Greshler Finance proposed terms (Greshler) — assigned:Oscar
- [ ] **[Med]** Follow up with Agnes — new potential investor met in Europe — assigned:Tony
- [ ] **[Med]** Ask Todd Platt on next call (Todd Platt) — assigned:Tony
- [ ] **[Med]** Meet Fred Rothman in Florida (Fred Rothman) — assigned:Tony
- [ ] **[Med]** Call Sekisui (Sekisui House) — assigned:Tony
- [ ] **[Med]** Reschedule Samsung Fire & Marine meeting — assigned:Tony
...
- [ ] **[Med]** UTIMCO / Hillwood / AREC reference call — 10:30 CT confirmed with Fred Balda (Hillwood President) for Jared Brimberry (UTIMCO) — assigned:Zach
...
- [ ] **[Hi]** Call Stephen O'Kane week of March 9 — multi-family office, very interested in Fund II (Heritage Holdings) — assigned:Oscar
